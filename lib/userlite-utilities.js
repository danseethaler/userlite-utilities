    ...
    activate: function(state) {
        ...
        atom.commands.add('atom-workspace', {
            ...
            'userlite-utilities:Cleanup': function() {
                ...
                // This is now implimented on file open by default
            ...
            'userlite-utilities:ulMasterUrl': function() {
                ...
                if (!atom.project.remoteftp.isConnected()) {
                    ...
                    if (config.fullPath == 'pages') {
                        var path = '/' + ftpConfig.userlite.mappings[config.appId] + '/frontend/pages/inc.php';
                    } else if (config.appSide == 'front') {
                        var path = '/' + ftpConfig.userlite.mappings[config.appId] + '/frontend/mods/' + config.fullPath;
                    } else {
                        var path = '/' + ftpConfig.userlite.mappings[config.appId] + '/backend/App/Instance.php';
                    }

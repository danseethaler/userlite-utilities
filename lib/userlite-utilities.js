    ...
    activate: function(state) {
        ...
        atom.commands.add('atom-workspace', {
            ...
            'userlite-utilities:insert-arrow': function() {
                var ref;
                return (ref = atom.workspace.getActiveTextEditor()) != null ? ref.insertText('->') : void 0;
            },
            ...
            'userlite-utilities:Clean': function(event) {
                return methods.clean(event);
            }
